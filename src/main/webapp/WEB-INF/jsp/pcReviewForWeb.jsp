...
<body>
  ...
  <!-- Page Header -->
  <header class="masthead" style="background-image: url('resources/img/pcReviewForWeb-bg.jpg')">
    <div class="overlay"></div>
    <div class="container">
      <div class="row">
        <div class="col-lg-12 col-md-10 mx-auto">
           <div class="site-heading">
            <h1>PC Review for Web</h1>
            <span class="subheading">PC의 부품의 정보와 견적 정보관리를 WEB에서 할 수 있게 하는 프로젝트입니다.</span>
          </div>
        </div>
      </div>
    </div>
