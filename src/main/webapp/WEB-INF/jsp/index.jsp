      ...
      <div class="row">
        <div class="col-lg-12 col-md-10 mx-auto">
          <div class="site-heading">
            <h1>PC Review</h1>
            <span class="subheading">PC의 부품의 정보와 견적 정보관리를 PC와 WEB에서 할 수 있게 하는 프로젝트입니다.</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-lg-12 col-md-10 mx-auto">
        <div class="post-preview">
          <a href="pcReviewForWeb">
            <h2 class="post-title">
              PC Review for Web
            </h2>
            <h3 class="post-subtitle">
              이 프로젝트는 PC 부품의 정보 관리와 견적 관리를 웹에서 하는 걸 목표로 하는 프로젝트입니다.
            </h3>
          </a>
        </div>
        <hr>
        <div class="post-preview">
          <a href="pcReviewForPC">
            <h2 class="post-title">
              PC Review for PC
            </h2>
            <h3 class="post-subtitle">
              이 프로젝트는 PC 부품의 정보 관리와 견적 관리를 PC에서 하는 걸 목표로 하는 프로젝트입니다.
            </h3>
          </a>
        </div>
        <hr>
