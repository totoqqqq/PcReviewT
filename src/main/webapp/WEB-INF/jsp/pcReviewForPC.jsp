...
<body>
  ...
  <!-- Page Header -->
  <header class="masthead" style="background-image: url('resources/img/pcReviewForPC-bg.jpg')">
    <div class="overlay"></div>
    <div class="container">
      <div class="row">
        <div class="col-lg-12 col-md-10 mx-auto">
           <div class="site-heading">
            <h1>PC Review for PC</h1>
            <span class="subheading">PC의 부품의 정보와 견적 정보관리를 PC에서 할 수 있게 하는 프로젝트입니다.</span>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    <div class="row">
      ...
      <h1><a href="javascript:void(window.open('https://github.com/totoqqqq/pcReview','_blank','width=1280, height=1080', resizable='no', toolbars='no', menubar='no'))">시작하기</a></h1>
      </div>
    </div>
  </div>
  <hr>
